            ...
            @if (!Auth::guest())
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="{{url('user')}}">Trang cá nhân</a>
                        ...
                        @if (!Auth::guest())
                            ...
                            <li>
                                ...
                                <div id="dropdown2" class="dropdown-content2 title-notice">
                                    <p class="dropdown2-top">Bạn có {{Auth::user()->newNotice->count()}} thông báo mới</p>
                                    ...
                                    @endforeach
                                    <hr>
                                    <a class="dropdown2-a" href="{{url('notice')}}" style="decoration:none;">Xem thêm</a>
                                </div>
                                <!-- </div> -->
                            </li>
                        @else
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form method="GET"action="{{url('search')}}">
                                ...
                                <input type="text" name="text" placeholder="Nhập vào từ khóa tìm kiếm...">
